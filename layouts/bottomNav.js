  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        ...
        >
          <Icon name="home" size={26} color={currentTab === 'home' ? darkBrown : '#000'} />
        ...
        >
          <Icon name="magnify" size={26} color={currentTab === 'search' ? darkBrown : '#000'} />
        ...
        >
          <Icon name="map-marker" size={26} color={currentTab === 'map' ? darkBrown : '#000'} />
        ...
        >
          <Icon name="cog" size={26} color={currentTab === 'settings' ? darkBrown : '#000'} />
